...
window.LEAGUE_OF_LISTENING_ITEMS = [
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Biraz /sola/, hayır, benim soluma, mükemmel, mükemmel."
      },
      {
        id: "b",
        text: "Olivia : Biraz sağa, hayır, benim sağıma, mükemmel, mükemmel."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Her akşam ne yaparsın? Ava : Okul çantamı kontrol eder ve hazırlarım."
      },
      {
        id: "b",
        text: "Benjamin : Her /sabah/ ne yaparsın? Ava : /Ders programımı kontrol eder/ ve okul çantamı hazırlarım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Saat kaçta fen dersi çalışırsın ? Ethan : Her akşam çalışırım."
      },
      {
        id: "b",
        text: "Emma : /Ne zaman/ fen dersi çalışırsın ? Ethan : Her /öğleden sonra/ çalışırım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Sunny, susar mısın, tamam, ben kazandım."
      },
      {
        id: "b",
        text: "Ella : Sunny, /tekrar eder misin/, tamam, /sen kazandın./"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Buddy, koş oğlum, Buddy, devam et!"
      },
      {
        id: "b",
        text: "Ava : Buddy, yanlış yoldasın, Buddy, geri gel!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Victoria : Pixel, /aklından bile geçirme/, iyi seçim."
      },
      {
        id: "b",
        text: "Victoria : Pixel, bunu deneme, kötü seçim."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : /Elli altı, elli yedi/."
      },
      {
        id: "b",
        text: "Lucas : Altmış altı, altmış yedi."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Otur, /ayağa kalkma/, otur, eh işte, neredeyse oldu."
      },
      {
        id: "b",
        text: "Ava : Ayağa kalk, oturma, ayağa kalk, eh işte, neredeyse oldu"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Storm, /kameraya bak/, sadece bir fotoğraf!"
      },
      {
        id: "b",
        text: "Hannah : Storm, kameradan uzaklaş, sadece bir fotoğraf!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Herkese söyle. Sunny : Kimseye söylemeyeceğim!"
      },
      {
        id: "b",
        text: "Ella : Kimseye /söyleme/. Sunny : Herkese söyleyeceğim!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : /Tekrar dene/, ama /daha iyi/ dene."
      },
      {
        id: "b",
        text: "Ella : Tekrar deneme, belli ki ben daha iyiyim."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Havuçunu ye, bunu yapacağını biliyordum."
      },
      {
        id: "b",
        text: "Mia : /Marulunu/ ye, bunu yapacağını biliyordum."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : O yüz işe yaramayacak, Tamam, bana /bakmayı bırak/."
      },
      {
        id: "b",
        text: "Ava : O yüz işe yaramayacak, Tamam, al ye bakalım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Şunu bir tadar mısın, Dürüst ol. Chloe : Lütfen bir tane daha."
      },
      {
        id: "b",
        text: "Emma : /Ne düşünüyorsun/, Dürüst ol. Chloe : Lütfen /daha fazla yap/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Evet, peki, sen genellikle kazanıyorsun."
      },
      {
        id: "b",
        text: "Ella : Hayır, hâlâ hayır, peki, sen /hep/ kazanıyorsun."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Storm beni /her zaman/ dinler, Storm, buraya gel, Şey, /genellikle/ dinler."
      },
      {
        id: "b",
        text: "Hannah : Storm beni genellikle dinler, Storm, buraya gel, Şey, bazen dinler."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Chloe, ne yapıyorsun? Chloe : Sadece eğleni/yor/um."
      },
      {
        id: "b",
        text: "Olivia : Chloe, ne yapıyorsun? Chloe : Sadece fotoğraf çekiliyorum."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Storm, O senindi!"
      },
      {
        id: "b",
        text: "Hannah : Storm, O /benimdi/!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Luna, /ne yapıyorsun/, tamam, sen çal, ben dinleyeceğim."
      },
      {
        id: "b",
        text: "Chloe : Luna, nereye gidiyorsun, tamam, sen çal, ben dışarı çıkacağım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Victoria : Harika, şimdi de oyun mu oynuyorsun?"
      },
      {
        id: "b",
        text: "Victoria : Harika, şimdi de /kod mu yazıyorsun/?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Heyyy, kitap okumam lazım."
      },
      {
        id: "b",
        text: "Chloe : Heyyy, kitap oku/yor/um."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : /Daniel'ın/ spor çantası hâlâ burada. Benjamin : Yine mi? Lucas : Evet, birazdan geri döner."
      },
      {
        id: "b",
        text: "Lucas : Daniel'ın tenis raketi hala burda. Benjamin : Yine mi? Lucas : Evet, birazdan geri döner."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Zoe : Kalenin avlusu çok büyük. Mia : Ve kule buradan bakınca daha da büyük."
      },
      {
        id: "b",
        text: "Zoe : Kalenin avlusu çok büyük. Mia : Ve kule buradan bakınca /daha da uzun/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Sokak fuarının müziği gittikçe /daha yüksek sesli/ oluyor. Emma : Güzel, /daha da yaklaşıyor/ olmalıyız."
      },
      {
        id: "b",
        text: "Hannah : Sokak fuarının müziği kulağa hoş geliyor. Emma : Güzel, daha da yaklaşıyor olmalıyız."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Bu ahşap ev şu apartman dairesinden daha az güzel görünüyor. Zoe : Evet, ama apartman dairesi daha eski."
      },
      {
        id: "b",
        text: "Mia : Bu ahşap ev şu apartman dairesi/nden daha/ güzel görünüyor. Zoe : Evet, ama apartman dairesi /daha/ modern."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : O apartman ahşap evden çok daha yüksek. Zoe : Doğru, ama ahşap ev daha geleneksel görünüyor."
      },
      {
        id: "b",
        text: "Mia : O apartman ahşap evden çok daha kısa. Zoe : Doğru, ama ahşap ev daha modern görünüyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Noah : Bu televizyon şundan daha küçük. Ethan : Evet, ama şu daha az gelişmiş ve daha ucuz."
      },
      {
        id: "b",
        text: "Noah : Bu televizyon şundan /daha/ büyük. Ethan : Evet, ama şu /daha/ gelişmiş ve /daha/ pahalı."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Zürafa zebradan /daha/ uzun. Chloe : Evet, ve boynunda tıpkı bizimki gibi yalnızca yedi kemik var."
      },
      {
        id: "b",
        text: "Ava : Zürafa zebradan daha büyük. Chloe : Evet, ve boynunda tıpkı bizimki gibi yalnızca yedi kemik var."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : Köpekbalığının vücudunda kemik /yoktur/. Jack : Evet, ve köpekbalıkları ağaçlardan /daha/ eskidir."
      },
      {
        id: "b",
        text: "Lucas : Köpekbalığının vücudunda kemikler vardır. Jack : Evet, ve köpekbalıkları ağaçlardan daha büyüktür."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Ahtapotun kalbi yoktur. Hannah : Evet, ve kanı da mavidir."
      },
      {
        id: "b",
        text: "Emma : Bir ahtapotun üç kalbi /vardır/. Hannah : Evet, ve kanı mavidir."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Bir filin hortumunda 40.000'den fazla kas vardır. Ella : Evet, ve fil gergedandan daha ağırdır."
      },
      {
        id: "b",
        text: "Olivia : Bir filin hortumunda 40.000'den fazla kas vardır. Ella : Evet, ve gergedan filden daha akıllıdır."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Bir koalanın parmak uçlarında parmak izi yoktur. Emma : Evet, ve kanguru koaladan çok daha uzundur."
      },
      {
        id: "b",
        text: "Chloe : Bir koalanın parmak uçlarında tıpkı bizimkiler gibi parmak izleri /vardır/. Emma : Evet, ve kanguru koaladan çok daha uzundur."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Hız treni çarpışan arabalar kadar hızlı. Ella : Katılıyorum, ama çarpışan arabalar daha eğlenceli : Vay!"
      },
      {
        id: "b",
        text: "Daniel : Hız treni çarpışan arabalardan /daha/ hızlı. Ella : Katılıyorum, ama çarpışan arabalar /daha/ eğlenceli. Daniel : Vay!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Haklıydın! Bu gerçekten çarpışan arabalardan daha heyecanlı ve daha keyifli! Daniel : Sana söylemiştim!"
      },
      {
        id: "b",
        text: "Ella : Haklıydın! Bu gerçekten çarpışan arabalardan /daha hızlı/ ve /daha eğlenceli/! Daniel : Sana söylemiştim!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Şurada dev bir dönme dolap var. Zoe : Ve kapının yanında çarpışan arabalar var. Mia : Önce çarpışan arabaları deneyelim! Zoe : Hadi!"
      },
      {
        id: "b",
        text: "Mia : Şurada dev bir atlıkarınca var. Zoe : Ve kapının yanında dönme dolap var. Mia : /Hadi/ önce atlıkarıncayı deneyelim! Zoe : Hadi!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Bu köprü beklediğimden daha alçak! Lars : Ve son köprüden daha güvenli! Hannah : Hay aksi!"
      },
      {
        id: "b",
        text: "Hannah : Bu köprü beklediğimden /daha yüksek/! Lars : Ve son köprüden /daha tehlikeli/! Hannah : Hay aksi!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Dönme dolap, Atlıkarıncadan daha güzel. Chloe : Katılıyorum, atlıkarınca daha güzel."
      },
      {
        id: "b",
        text: "Olivia : Atlıkarınca dönme dolaptan /daha/ güzel. Chloe : Öyle düşünmüyorum, dönme dolap /daha/ parlak."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Bu anahtar diğerinden /daha büyük/. Javier : Evet, ama daha küçüğü bunun için daha iyi."
      },
      {
        id: "b",
        text: "Daniel : Bu anahtar diğerinden daha küçük. Javier : Evet, ama daha büyüğü bunun için daha iyi."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Jack : Bundan daha lezzetli bir balık yakalayabilirim. Callum : O zaman kanıtla. Jack : Bir tane yakaladım!"
      },
      {
        id: "b",
        text: "Jack : Bundan /daha büyük/ bir balık yakalayabilirim. Callum : O zaman kanıtla. Jack : Bir tane yakaladım!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : T. rex beklediğimden daha korkunç! Julien : Ve dişleri nerdeyse elin kadar."
      },
      {
        id: "b",
        text: "Chloe : T. rex beklediğimden /daha büyük/! Julien : Ve dişleri elinden /daha uzun/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Anne, kızağım seninkinden /daha hızlı/! Elena : Öyle mi düşünüyorsun? Daniel : Düşünmüyorum, biliyorum!"
      },
      {
        id: "b",
        text: "Daniel : Anne, kızağım çok hızlı! Elena : Öyle mi düşünüyorsun? Daniel : Düşünmüyorum, biliyorum!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Pizzan benimkinden daha lezzetli görünüyor. Giulia : Seninki daha küçük görünüyor."
      },
      {
        id: "b",
        text: "Mia : Pizzan benimkinden /daha büyük/. Giulia : Ama seninki /daha/ lezzetli görünüyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Anne, çiçeğim seninkinden /daha uzun/. Camille : Evet, ama benimkinin /daha çok/ çiçeği var."
      },
      {
        id: "b",
        text: "Chloe : Anne, çiçeğin beninkinden daha kısa. Camille : Evet, ama benimkinin daha az çiçeği var."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Beklediğim kadar uzun! David : Ve senin kadar hızlı koşamaz!"
      },
      {
        id: "b",
        text: "Ava : Beklediğimden /daha uzun/! David : Ve senden /daha hızlı/ koşabilir!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : Vay canına! İtfaiye aracı arabamızdan /daha büyük/! Gabriel : Ve çok /daha gürültülü/!"
      },
      {
        id: "b",
        text: "Lucas : Vay canına! İtfaiye aracı sandığım kadar büyük değil! Gabriel : Ama çok daha sesli!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Bu kimin röntgeni? Amina : Bu yavru köpeğin röntgeni."
      },
      {
        id: "b",
        text: "Ava : Bu yavru köpeğ/in röntgeni/ mi? Amina : Evet, bu da yavru köpeğ/in oyuncağı./"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Anne, Benjamin o mavi arabanın içinde! Benjamin : Ve aramızda kimse yok!"
      },
      {
        id: "b",
        text: "Hannah : Anne, Benjamin o mavi arabanın içinde! Benjamin : Ve aramızda /hiç araba/ yok!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Anne, bu senin peruğun mu? Fiona : Hayır, /mankenin/."
      },
      {
        id: "b",
        text: "Olivia : Anne, bu müşterinin peruğu mu? Fiona : Evet, benim."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Baba, aşağıdaki bir mağara mı! Lars : Evet ve vadinin üzerinde de şahinler var. Hannah : Nerede?"
      },
      {
        id: "b",
        text: "Hannah : Baba, aşağıda bir /şelale/ var! Lars : Ve vadinin üzerinde /kartallar/ var. Hannah : Nerede?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "David : Anne, bu otel /misafirinin/ valizi mi? Valeria : Evet, /sihirbazın/."
      },
      {
        id: "b",
        text: "David : Anne, bu otel aşçısının valizi mi? Valeria : Hayır, müşterinin."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Çilekleri verir misin? Olivia : Tabi, işte burda."
      },
      {
        id: "b",
        text: "Ella : Çilekler sende mi? Olivia : Evet, işte /burada/ bende."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "David : Anne, balımız var mı? Valeria : Evet, tam burada /biraz var/."
      },
      {
        id: "b",
        text: "David : Anne, balımız var mı? Valeria : Hayır, hiç balımız yok."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Anne, her şeyi aldık mı? Giulia : Evet çileğimiz de var. Mia : Harika hadi gidelim!"
      },
      {
        id: "b",
        text: "Mia : Anne, her şeyi aldık mı? Giulia : Neredeyse, ama hiç çileğimiz yok. Mia : Şurada var, alalım!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Patates kızartmalarından biraz /alabilir miyim/? Lucas : Tabii, ama sadece birkaç tane."
      },
      {
        id: "b",
        text: "Daniel : Patates kızartmalarından biraz yiyebilir miyim? Lucas : Tabii, çokça al."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Noah : Peçeten /var mı/? Victoria : Evet, /biraz var/. Noah : Teşekkürler."
      },
      {
        id: "b",
        text: "Noah : Peçeteni verir misin? Victoria : Evet, buyur. Noah : Teşekkürler."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Anne, biraz daha peynir ekleyebilir misin? Sophie : Evet bolca ekle."
      },
      {
        id: "b",
        text: "Emma : Anne, biraz daha peynir /ekleyebilir miyim/? Sophie : Tabii, ama /sadece biraz/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : Baba, bir tanesini /çevirebilir miyim/? Gabriel : Tabii, maşayı kullan."
      },
      {
        id: "b",
        text: "Lucas : Baba, maşayı verir misin? Gabriel : Tabii, al bakalım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Şunlardan yemek istiyorum.? Esnaf : Tabi, buyur."
      },
      {
        id: "b",
        text: "Ava : Şunlardan birini /deneyebilir miyim/? Esnaf : Elbette, bir tane al."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Ne kadar muffinimiz var? Zoe : Dört. Mia : Peki kaç tane sütümüz var? Zoe : Çok fazla. Mia : Bu yeterli."
      },
      {
        id: "b",
        text: "Mia : /Kaç tane/ muffinimiz var? Zoe : Dört. Mia : Peki /ne kadar/ sütümüz var? Zoe : Çok değil. Mia : Bu yeterli değil."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : /Kaç tane/ sandviçe ihtiyacımız var? Daniel : Beş. Daniel : Hey! Lucas : Ve /biraz/ limonata, lütfen. Vendor : Tabii."
      },
      {
        id: "b",
        text: "Lucas : Sandviçe ihtiyacımız var mı? Daniel : Evet, İki tane. Daniel : Hey! Lucas : Ve bolca limonata, lütfen. Vendor : Tabii."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Dünden fotoğrafların /var mı/? Emma : Evet, /bir sürü var/! Chloe : Göster bana! Chloe : Bunu hemen sil!"
      },
      {
        id: "b",
        text: "Chloe : Dünden fotoğrafların var mı? Emma : Hayır, hiç yok! Chloe : Göster bana! Chloe : Bunu hemen sil!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Anne, bir tanesini /süsleyebilir miyim/? Camille : Tabii, ama onu çok fazla sallama."
      },
      {
        id: "b",
        text: "Chloe : Anne, bir tanesini süsleyebilir misin? Camille : Hayır, ona hiç dokunma."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Şu sostan istiyorum. Vendor : Elbette, ama çok ekşi."
      },
      {
        id: "b",
        text: "Hannah : Şu sosu deneyebilir miyim? Vendor : Elbette, ama çok /baharatlı./"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Her şeyimiz var mı? Ethan : Dur, popcornumuz /yok/!"
      },
      {
        id: "b",
        text: "Benjamin : Her şeyimiz tamam mı? Ethan : Dur, içeceklerimiz yok! "
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Benimkinde çok çikolata yok. İşte. Hannah : Dur, dur, dur! Chloe : Mükemmel."
      },
      {
        id: "b",
        text: "Chloe : Benimkinde /hiç çikolata yok/. Hannah : Dur, dur, dur! Chloe : Mükemmel."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Kaç sandviçimiz var? Emma : Sekiz. Hannah : Peki ne kadar meyve suyumuz var? Emma : Bolca! Emma : Henüz değil! Hannah : Acıktım! Emma : Diğerlerini bekle."
      },
      {
        id: "b",
        text: "Hannah : Kaç sandviçimiz var? Emma : İki. Hannah : Peki ne kadar meyve suyumuz var? Emma : Çok az! Emma : Henüz değil! Hannah : Acıktım! Emma : Diğerlerini bekle."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Zoe : Kaç elma alacağız? Ava : Altı. Zoe : Peki kaç paket pirinç? Ava : Bir paket yeter, tamam, sıra sende. Zoe : Güzel deneme."
      },
      {
        id: "b",
        text: "Zoe : Kaç elmaya /ihtiyacımız var/? Ava : Altı. Zoe : Peki /ne kadar/ pirinç? Ava : Bir paket yeter, tamam, sıra sende. Zoe : Güzel deneme."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Bir /cupcake/ istiyorum, lütfen. Emma : Bir /dilim çikolatalı kek/ alabilir miyim? Olivia : Ben de /buzlu çikolata/ istiyorum, lütfen."
      },
      {
        id: "b",
        text: "Chloe : Bir sandviç istiyorum, lütfen. Emma : Bir dilim limonlu kek alabilir miyim? Olivia : Ben de su istiyorum, lütfen."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Bir tavuklu sandviç var mı? Zoe : Bana da peynirli sphagetti."
      },
      {
        id: "b",
        text: "Mia : Bir tavuklu sandviç /alabilir miyim/, lütfen? Zoe : Bir peynirli tost /istiyorum/, lütfen."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Bir /tavuk dürüm/ istiyorum, lütfen. Jack : Bir /ton balıklı sandviç/ alabilir miyim? Ethan : Bana bir peynirli sandviç, lütfen."
      },
      {
        id: "b",
        text: "Benjamin : Bir tavuk burger istiyorum, lütfen. Jack : Bir tavuk sandviç alabilir miyim? Ethan : Bana bir peynirli tost, lütfen."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Evet, tavuklu sandviç ve kola istiyorum, lütfen. Lars : Ben de ton balığı istiyorum, lütfen."
      },
      {
        id: "b",
        text: "Hannah : Evet, /tavuk ve pilav/ istiyorum, lütfen. Lars : Ben de /ızgara balık/ istiyorum, lütfen."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Papağanlar sesleri duyabilirler, dinle, merhaba. Sunny : Merhaba, merhaba. Ella : Tamam, anladık."
      },
      {
        id: "b",
        text: "Ella : Papağanlar sesleri /taklit edebilir/, dinle, merhaba. Sunny : Merhaba, merhaba, merhaba, merhaba. Ella : Tamam, anladık."
      }
    ],
    ...
    functions: [
      "use_of_modal_can_for_capability_and_ability"
    ],
    theme: "life_in_nature",
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Storm gerçekten /çok yükseğe zıplayabilir/, aferin oğlum, noldu, elma mı istiyorsun?"
      },
      {
        id: "b",
        text: "Hannah : Storm gerçekten çok uzağa zıplayabilir, aferin oğlum, noldu, elma mı istiyorsun?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Filler gerçekten yüzebilir mi? Guide : Hayır, hiç yüzemezler. Hannah : O kocaman vücutlarıyla mı? Guide : Hayır. Hannah : Bu inanılmaz!"
      },
      {
        id: "b",
        text: "Hannah : Filler gerçekten yüzebilir mi? Guide : Evet, çok iyi /yüzebilirler/. Hannah : O kocaman vücutlarıyla mı? Guide : Evet. Hannah : Bu inanılmaz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Vay, penguenler çok hızlı /yüzebilir/. Olivia : Evet, ama /uçamazlar/. Ella : Ama şöyle yürüyebilirler!"
      },
      {
        id: "b",
        text: "Ella : Vay, penguenler çok hızlı uçar. Olivia : Evet, ama yüzemezler. Ella : Ama şöyle yürüyebilirler!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Çitalar gerçekten o kadar hızlı koşamaz mı? Lucas : O kadar da hızlı koşamazlar. Benjamin : Tamam, bu hızlı."
      },
      {
        id: "b",
        text: "Benjamin : Çitalar gerçekten o kadar hızlı koşabilir mi? Lucas : Evet, çok /hızlı koşabilirler/. Benjamin : Tamam, bu hızlı."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Noah : Peki, onu kaldırabilir misin? Lucas : Şey, /kaldıramam/. Noah : Ben /kaldırabilirim/! Lucas : Olamaz!"
      },
      {
        id: "b",
        text: "Noah : Peki, onu kaldıramaz mısın? Lucas : Şey, kaldırabilirim. Noah : Ben de kaldıramam! Lucas : Olamaz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Timsahlar yemek olmadan yaşayamazlar, ben de gofretsiz yaşayamıyorum."
      },
      {
        id: "b",
        text: "Mia : Timsahlar yemek olmadan aylarca /yaşayabilir/, ama ben gofretsiz iki dakika /yaşayamıyorum/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Goriller insanlardan on kat daha güçlü olabilir!"
      },
      {
        id: "b",
        text: "Ava : Goriller insanlardan beş kat daha güçlü olabilir!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Yılanlar dilleriyle tat alabilir, şey galiba ben alamıyorum."
      },
      {
        id: "b",
        text: "Daniel : Yılanlar dilleriyle koku alabilir, şey galiba ben alamıyorum."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Bazı papağanlar yüzlerce kelime /öğrenebilir/. Sunny : Merhaba! Ella : Ama görünüşe göre benim papağanım /öğrenemiyor./"
      },
      {
        id: "b",
        text: "Ella : Bazı papağanlar hiç kelime öğrenemez. Sunny : Merhaba! Ella : Ama görünüşe göre benim papağanım öğrenebiliyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Bukalemunlar gözlerini hep aynı yönde tutmak zorundadır!"
      },
      {
        id: "b",
        text: "Chloe : Bukalemunlar gözlerini farklı yönlere /hareket ettirebilir/!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Dur, burada çiçekleri /koparmamalıyız/. Hannah : Doğru, doğada kalmalılar."
      },
      {
        id: "b",
        text: "Emma : Dur, şurdan biraz çiçek toplayalım. Hannah : Evet, ama önce selfi çekilelim."
      }
    ],
    ...
    functions: [
      "use_of_modal_must_for_external_obligation"
    ],
    theme: "life_in_nature",
    unit: "life_in_the_nature",
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Burada çok gürültü yapmamalıyız. Olivia : Tamam, kuşlar çok yakında, oops, üzgünüm."
      },
      {
        id: "b",
        text: "Ava : Burada /sessiz olmalıyız/. Olivia : Tamam, kuşlar çok yakında, oops, üzgünüm."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Parkı /temiz tutmalıyız/, Jack. Jack : Tabii, hayvanların yaşam alanını /korumalıyız/."
      },
      {
        id: "b",
        text: "Benjamin : Parkı kirletmemeliyiz, Jack. Jack : Tabii, hayvanların yaşam alanını temizlemeliyiz."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ethan : Vahşi hayvanları her zaman beslemeliyiz. Noah : Doğru, yiyeceklerini kendileri bulamazlar."
      },
      {
        id: "b",
        text: "Ethan : Vahşi hayvanları /asla beslememeliyiz/. Noah : Doğru, kendi yiyeceklerini bulmalılar."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Vahşi hayvanlara veya yuvalarına /dokunmamalıyız/. Zoe : Haklısın, onu yalnız bırakalım."
      },
      {
        id: "b",
        text: "Mia : Vahşi hayvanlara ve yuvalarını korumalıyız. Zoe : Haklısın, onu yanımıza alalım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Onlar nerede yaşar? Lucas : Et, bir kaplan tek öğünde yaklaşık kırk kilo yiyebilir! Daniel : Kırk kilo mu?!"
      },
      {
        id: "b",
        text: "Daniel : Onlar /ne/ yer? Lucas : Et, bir kaplan tek öğünde yaklaşık kırk kilo yiyebilir! Daniel : Kırk kilo mu?!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Goriller /nerede/ yaşar? Zoe : Afrika’daki ormanlarda yaşarlar, her gece yeni bir yatak yaparlar! Mia : Her gece mi?!"
      },
      {
        id: "b",
        text: "Mia : Goriller ne yer? Zoe : Ormandaki ağaçları yer, her gece farklı bir ağaçtan yerler! Mia : Her gece mı?!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Balinalar nerede yaşar? Olivia : Dünya çapındaki okyanuslarda yaşarlar, her yıl binlerce kilometre yolculuk ederler! Ella : Bu çok uzun bir yolculuk!"
      },
      {
        id: "b",
        text: "Ella : Balinalar ne yer? Olivia : Okyanusta yolculuk ederken ne bulurlarsa yerler! Ella : Bu çok zor olmalı!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Heyyy, kurabiyemi kim aldı?"
      },
      {
        id: "b",
        text: "Ava : Heyyy, kurabiyem nerede?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Timsahlar /nerede/ uyur? Olivia : Bazen suyun altında, saatlerce orada kalabilirler! Chloe : Su altında mı uyurlar?"
      },
      {
        id: "b",
        text: "Chloe : Timsahlar neden uyur? Olivia : Enerjileri tükendiğinde, saatlerce uyuyabilirler! Chloe : Su altında mı uyurlar?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Sunucu : Bazı penguenler eksi elli dereceden daha sıcak yerlerde yaşayabilir! Ella : Bu kadar sıcak mı?"
      },
      {
        id: "b",
        text: "Sunucu : Bazı penguenler eksi elli dereceden /daha soğuk/ yerlerde yaşayabilir! Ella : Bu kadar soğuk mu?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Zürafa dünyadaki /en uzun/ hayvan, değil mi? Olivia : Evet, neredeyse altı metre uzunluğunda olabilir! Ella : Altı metre mi, Vay canına."
      },
      {
        id: "b",
        text: "Ella : Zürafa tüm hayvanlardan daha uzun, değil mi? Olivia : Evet, neredeyse altı metre uzunluğunda olabilir! Ella : Altı metre mi, Vay canına."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Aslanlar en güçlü hayvanlardan biridir değil mi? Jack : Evet, bir aslanın gücü sekiz kaplana eşittir! Benjamin : Sekiz mi?!"
      },
      {
        id: "b",
        text: "Benjamin : Aslanlar /en yüksek/ kükremeye sahip, değil mi? Jack : Evet, bir aslanın kükremesini sekiz kilometre öteden duyabilirsin! Benjamin : Sekiz kilometre mi?!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Hangi hayvanın /en büyük/ dişleri var? Ava : Büyük beyaz köpek balığının en büyük dişleri vardır, dişleri yedi santimetre uzunluğundadır! Chloe : Grrrrrr, benim en keskin dişlerim var."
      },
      {
        id: "b",
        text: "Chloe : Hangi hayvanın en küçük dişleri var? Ava : Büyük beyaz köpek balığının en küçük dişleri vardır, dişleri yedi milimetre uzunluğundadır! Chloe : Grrrrrr, benim en keskin dişlerim var."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Sunucu : Afrika fili dünyadaki en hafif kara hayvanıdır, altı bin kilodan az gelir. Chloe : Luna, sen bir Afrika filinden daha ağırsın."
      },
      {
        id: "b",
        text: "Sunucu : Afrika fili dünyadaki /en ağır/ kara hayvanıdır, altı bin kilodan fazla gelebilir. Chloe : Luna, sen bir Afrika filinden daha ağırsın."
      }
    ],
    ...
    functions: [
      "comparative_and_superlative_adjectives"
    ],
    theme: "life_in_nature",
    unit: "life_in_the_nature",
    evidenceStart: "0:00.000",
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Sunucu : Yunuslar okyanustaki /en zeki/ hayvanlardır, öğrenebilir, oynayabilir ve birlikte çalışabilirler! Benjamin : Şey, benden /daha zeki/ görünüyorlar."
      },
      {
        id: "b",
        text: "Sunucu : Yunuslar okyanustaki en yavaş hayvanlardır, öğrenemez, oynayamaz ve birlikte çalışamazlar! Benjamin : Şey, benden daha yavaş görünüyorlar."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Sunucu : Atların tüm kara hayvanları arasında en küçük gözleri vardır! Hannah : Storm’un en güzel gözleri var. Ingrid : Görüyor musun, o da aynı fikirde."
      },
      {
        id: "b",
        text: "Sunucu : Atların tüm kara hayvanları arasında /en büyük/ gözleri vardır! Hannah : Storm’un en güzel gözleri var. Ingrid : Görüyor musun, o da aynı fikirde."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Jack : En küçük balık geliyor, şimdiye kadarki en şanslı çocuğum."
      },
      {
        id: "b",
        text: "Jack : /En büyük/ balık geliyor, şimdiye kadarki /en şanslı/ av."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Krep /nerede/?"
      },
      {
        id: "b",
        text: "Emma : Krepe ne oldu?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Victoria : Pixel, /neredesin/? Victoria : Oraya nasıl çıktın?"
      },
      {
        id: "b",
        text: "Victoria : Pixel, ne yapıyorsun? Victoria : Oraya ne zaman çıktın?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Victoria : Şifremi değiştirmişler, Nasıl ya?"
      },
      {
        id: "b",
        text: "Victoria : Şifremi /hatırlayamıyorum/, Nasıl ya?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Her şeyi atabilirim, ama topu tutamadım."
      },
      {
        id: "b",
        text: "Benjamin : Her şeyi /yakalayabilirim/, belli ki /her şeyi/ değil."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Anahtarlarımı kim aldı, Teşekkür ederim?"
      },
      {
        id: "b",
        text: "Ava : Anahtarlarım /nerede/, Teşekkür ederim?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Onu hemen yiyebilirim, Şey, çok yaklaşmıştım."
      },
      {
        id: "b",
        text: "Chloe : Onu ağzımla /yakalayabilirim/, Şey, çok yaklaşmıştım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Acaba kim? Sunny : O Olivia, Ella : Artık /okuyabiliyor/ musun?"
      },
      {
        id: "b",
        text: "Ella : Acaba kim? Sunny : O Olivia, Ella : Artık konuşabiliyor musun?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Ne yap/acaksın/? Hannah : Vadiyi keşfed/eceğim/!"
      },
      {
        id: "b",
        text: "Emma : Ne yaptın? Hannah : Vadiyi keşfettim!"
      }
    ],
    ...
    functions: [
      "be_going_to_future_tense_for_plans"
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Kum tepelerini görecek miyiz? Jack : Evet, ayrıca şnorkelle dalış yapacağız!"
      },
      {
        id: "b",
        text: "Benjamin : /Mercan resifini/ görecek miyiz? Jack : Evet, şnorkelle dalış yapacağız!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : Çölde ne yapacağız? Daniel : /Deveye bineceğiz/!"
      },
      {
        id: "b",
        text: "Lucas : Çölde ne yapacağız? Daniel : Ata bineceğiz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin : Gezimizde ne yapacağız? David : Bu harika kanyonu /keşfedeceğiz/!"
      },
      {
        id: "b",
        text: "Benjamin : Gezimizde ne yağacağız? David : Bu harika kanyona gideceğiz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Adada ne yapacağız? Charlotte : /Geziye çıkacağız/! Ella : Harika!"
      },
      {
        id: "b",
        text: "Ella : Adada ne yaptık? Charlotte : Adada uyuduk! Ella : Harika!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Ara tatilde ne yapacaksın? Emma : Büyükannemi ve büyükbabamı ziyaret edeceğim!"
      },
      {
        id: "b",
        text: "Chloe : Ara tatilde ne yaptın? Emma : Büyükannemi ve büyükbabamı ziyaret ettim!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Tatilde plaja gidecek misin? Ella : Evet, her gün yüzeceğim! Hey, mayom nerede?"
      },
      {
        id: "b",
        text: "Olivia : Tatilde plaja gittin mi? Ella : Evet, her gün yüzdüm! Hey, havlum nerede?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Bu ara tatilde ne yapacaksın? Victoria : Londra'yı ziyaret edeceğim! Mia : Bunu beğendim."
      },
      {
        id: "b",
        text: "Mia : Bu ara tatilde /nereye/ gideceksin? Victoria : Londra’yı ziyaret edeceğiz! Mia : Bunu beğendim."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Tatilde nereye gideceksin? Hannah : Norveç’e gideceğim, orası soğuk! Hannah : Bir cekete /ihtiyacım var/."
      },
      {
        id: "b",
        text: "Ava : Bayramda nereye gideceksin? Hannah : Norveç'e gideceğim, orası soğuk! Hannah : Bir ceket alacağım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Noah : Orada ne yapacağız? Ethan : Şu tepeden aşağı ineceğiz!"
      },
      {
        id: "b",
        text: "Noah : Orada ne yapacağız? Ethan : Şu tepeye tırmanacağız!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Jack : Ara tatilinde ne yapacaksın? Daniel : /Yolculuğa çıkacağım/!"
      },
      {
        id: "b",
        text: "Jack : Ara tatilinde ne yapacaksın? Daniel : Evde kalacağım!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Zoe : Bu yaz nereye gideceksin? Mia : Şehirde kalacağım!"
      },
      {
        id: "b",
        text: "Zoe : Bu yaz nereye gideceksin? Mia : /Sahilde/ kalacağım!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ethan : Bu hafta sonu ne yapacaksın? Lucas : /Lunaparkı/ ziyaret edeceğim!"
      },
      {
        id: "b",
        text: "Ethan : Bu hafta sonu ne yapacağız? Lucas : Müzeleri ziyaret edeceğiz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Emma : Bu hafta sonu nereye gideceğiz? Sophie : Lunaparka gideceğiz!"
      },
      {
        id: "b",
        text: "Emma : Bu hafta sonu ne yapacağız? Sophie : Hayvanat bahçesini ziyaret edeceğiz!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Oliver : Sahilde ne /yapacaksın/? Benjamin : Plaj voleybolu /oynayacağım/! Oliver : İyi plan!"
      },
      {
        id: "b",
        text: "Oliver : Sahilde ne yaptın? Benjamin : Plaj voleybolu oynadım! Oliver : İyiymiş!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Fiona : Yarın ne yapacağız? Olivia : Müzeleri ziyaret edeceğiz!"
      },
      {
        id: "b",
        text: "Fiona : Yarın ne yapacağız? Olivia : /Geziye çıkacağız/!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Bu yaz /nereye/ gideceğiz? Amina : Kenya’yı ziyaret edeceğiz! Ava : Buddy de gelebilir mi?"
      },
      {
        id: "b",
        text: "Ava : Bu yaz ne yapacağız? Amina : Kenya’yı ziyaret edeceğiz! Ava : Buddy de gelecek!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Julien : Bugün ne yapacaksın? Chloe : Dev deniz kabuğu bulacağım, Dev gibi!"
      },
      {
        id: "b",
        text: "Julien : Bugün ne yapacaksın? Chloe : Dev bir /kumdan kale/ yapacağım, Daha büyük!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Giulia : Şimdi ne yapacaksın? Mia : /Deniz kabukları toplayacağım/!"
      },
      {
        id: "b",
        text: "Giulia : Şimdi nereye gideceğiz? Mia : Kumdan kale yapmaya!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Charlotte : Önce neye bineceksin? Ella : /Hız trenine/ bineceğim!"
      },
      {
        id: "b",
        text: "Charlotte : Önce neye bineceksin? Ella : Dönme dolaba bindim!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "David : Ne zaman kamp yapacağız? Valeria : Ne zaman istiyorsun? David : Hemen!"
      },
      {
        id: "b",
        text: "David : /Nerede/ kamp yapacağız? Valeria : /Nerede/ istiyorsun? David : Gölün yanında!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ingrid : Peki, şimdi /ne/ yapacaksın? Hannah : Uyuyacağım!"
      },
      {
        id: "b",
        text: "Ingrid : Peki, şimdi nereye gideceksin? Hannah : Uyumayacağım!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Zoe : Bu gece /ne/ izleyeceğiz? Nikos : Bir meteor yağmuru izleyeceğiz! Nikos : İşte, bak, bir dilek tut!"
      },
      {
        id: "b",
        text: "Zoe : Buraya neden geldik? Nikos : Yıldızları izleyeceğiz! Nikos : İşte, bak, bir yıldız kaydı!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Benim kadar hızlı gidemezsin. Hannah : Bundan emin misin?"
      },
      {
        id: "b",
        text: "Daniel : Beni yakalayamazsın. Hannah : Göreceğiz bakalım."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Daniel : Pekala, bu gerçekten çılgıncaydı. Hannah: Aferin, Storm. Daniel: Tekrar kapışalım mı? Hannah: Belki."
      },
      {
        id: "b",
        text: "Daniel : Pekala, bu gerçekten /hızlıydı/. Hannah: Aferin, Storm. Daniel: Tekrar kapışalım mı? Hannah: /Her zaman/!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Mia : Coco, o benim ödevim, ona ihtiyacım var, harika, tavşanım ödevimi yiyecek."
      },
      {
        id: "b",
        text: "Mia : Coco, o benim ödevim, ona ihtiyacım var, harika, tavşanım ödevimi /yedi/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Jack : /İnanamıyorum/. Benjamin : Bu yetenek. Jack : Yetenek mi? Benjamin : Sadece rüzgâr."
      },
      {
        id: "b",
        text: "Jack : Çok yeteneklisin. Benjamin : Sadece şans. Jack : Şans mı? Benjamin : Evet, iyi şans."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : koş Storm, getir, teşekkür ederim, Storm."
      },
      {
        id: "b",
        text: "Hannah : /Şapkam/, teşekkür ederim, Storm."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Tam böyle, peki, ne düşünüyorsun? Emma : O bundan /nefret etti/. Chloe : Onun zevki yok."
      },
      {
        id: "b",
        text: "Chloe : Tam böyle, peki, neye bakıyorsun? Emma : O buna bayıldı. Chloe : Onun zevki yok."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Mükemmel. Sunny : Hiç de /mükemmel değil/!"
      },
      {
        id: "b",
        text: "Ella : Mükemmel. Sunny : Gerçekten mükemmel!"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Luna, o benim /ödevimdi/."
      },
      {
        id: "b",
        text: "Chloe : Luna, o benim defterim."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Chloe : Durabilir misin?"
      },
      {
        id: "b",
        text: "Chloe : /Yer değiştirebilir misin/?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Benjamin ve Jack : Taş, kâğıt, makas! Benjamin : Bu /biraz uzun sürebilir./"
      },
      {
        id: "b",
        text: "Benjamin ve Jack : Taş, kâğıt, makas! Benjamin : Bu çok kolay olmayacak."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Olivia : Sadece tek bir /mükemmel/ fotoğraf, Evet, çok mükemmel."
      },
      {
        id: "b",
        text: "Olivia : Sadece tek bir güzel fotoğraf, Evet, çok güzel."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : /Rol yapmak yok/, zoraki hayaller yok, bu hayat benim /kendi hayatım./"
      },
      {
        id: "b",
        text: "Ella : İyi rol yapıyoruz, zoraki hayallerle, hayat hepimizin."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Lucas : Dünyanın en iyi şutu, İzle, Aha kediyi kurtardım."
      },
      {
        id: "b",
        text: "Lucas : Dünyanın en iyi şutu, İzle, /Belki bir dahaki sefere/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Belki o kadar /güçlü/ değilim, yine de nereye /ait olduğumu/ biliyorum."
      },
      {
        id: "b",
        text: "Ella : Belki çok güçlüyüm, yine de nereye gittiğimi biliyorum."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : /Aynı yollar/, aynı tarzlar, ama /hiçbiri/ bana iyi hissettirmiyor."
      },
      {
        id: "b",
        text: "Ella : Farklı yollar, farklı tarzlar, hepsi kendimi iyi hissettiriyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Yeni bir gün bugün başlıyor, Yeni maceralar geride kaldı."
      },
      {
        id: "b",
        text: "Ella : Yeni bir /yolculuk/ bugün başlıyor, Yeni maceralar /yolda/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Bir /kelime/ ve bir /gülümseme/ daha, Her adım denemeye değer."
      },
      {
        id: "b",
        text: "Ella : Bir kelime ve bir gülümseme daha yok, Her adım denemeye değer."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Öğretmenler ve öğrenciler yan yana, hep birlikte gururla öğreniyoruz."
      },
      {
        id: "b",
        text: "Ella : /Kitaplar ve hayaller/ yan yana, Arkadaşlarımla gururla öğreniyorum."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Küçük anlar, gün be gün, Başka bir yol bulmama yardım ediyor."
      },
      {
        id: "b",
        text: "Ella : Küçük anlar, her yıl, Başka bir yol bulmama yardım ediyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Öğrenemeyebilirim, unutabilirim, Bilmek istediğim çok fazla şey var."
      },
      {
        id: "b",
        text: "Ella : /Öğrenebilirim, gelişebilirim/, Bilmek istediğim çok fazla şey var."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : /Bugün öğren, yarın parla/, Her /üzüntüyü/ geride bırak."
      },
      {
        id: "b",
        text: "Ella : Yarın öğren, bugün parla, Her mutluluğu geride bırak."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Kelime kelime, adım adım, Dünden daha çalışkanım."
      },
      {
        id: "b",
        text: "Ella : Kelime kelime, adım adım, /Dünden daha güçlüyüm/."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Victoria : Neyi /yanlış yapıyorum/, Bunu nasıl yaptın?"
      },
      {
        id: "b",
        text: "Victoria : Pixel gel buraya nerdesin, Bunu sen mi yaptın?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : /Birlikte öğrenmek/, sonraki satır neydi? Sunny : /Birlikte Büyümek/."
      },
      {
        id: "b",
        text: "Ella : Birlikte şarkı söylemek, sonraki satır neydi? Sunny : Birlikte Dans Etmek."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ava : Bunu kim açacak, Bunu neden yapabiliyorsun?"
      },
      {
        id: "b",
        text: "Ava : Bunu nasıl /açacağım/, Bunu nasıl yapabiliyorsun?"
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Buradan /sola dön/, Tamam, o zaman sağa git."
      },
      {
        id: "b",
        text: "Hannah : Buradan düz git, Tamam, o zaman dur."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Bu yeni yazdığım şarkıya bak, Olivia : Gelmiş geçmiş en kötü şarkı."
      },
      {
        id: "b",
        text: "Ella : Yazdığım yeni şarkıyı /dinle/, Olivia : Gelmiş geçmiş en güzel şarkı."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Hannah : Storm /taranmayı/ seviyor, Görünüşe göre yalnızca fırçayı seviyor."
      },
      {
        id: "b",
        text: "Hannah : Storm koşmayı seviyor, Görünüşe göre yalnızca fırçayı seviyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Bugün öğren, çok çalış, Denemezsek korkacak çok şey var."
      },
      {
        id: "b",
        text: "Ella : Bugün öğren, /Çok büyük hayaller kur/, Denediğimizde korkacak hiçbir şey yok."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Her ders, Her /gülümseme/, Beni /hedefime/ yaklaştırıyor."
      },
      {
        id: "b",
        text: "Ella : Her ders, Her üzüntü, Beni biraz daha büyütüyor."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Her soru görmeme yardım ediyor, Gerçekten kim olmak istediğimi."
      },
      {
        id: "b",
        text: "Ella : Her /cevap/ görmeme yardım ediyor, Gerçekten kim olmak istediğimi."
      }
    ],
  ...
  },
  {
    ...
    answerOptions: [
      {
        id: "a",
        text: "Ella : Düşersem, yeniden ayağa kalkarım, işte hep bu şekilde /kazanırım/."
      },
      {
        id: "b",
        text: "Ella : Düşersem, yeniden ayağa kalkamam, işte hep bu yüzden kaybederim."
      }
    ],
  ...
  {
    id: "ava_daily_routine_part1",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about getting ready in the morning.",
    transcript: "Ava : I get up at 7 every morning, I always wash my face and I brush my teeth.",
    answerOptions: [
      { id: "a", text: "Ava : Her sabah saat 7'de kalkarım, Her zaman yüzümü yıkar ama dişlerimi fırçalamam." },
      { id: "b", text: "Ava : Her sabah saat 7'de kalkarım, Her zaman yüzümü yıkar ve dişlerimi fırçalarım." }
    ],
    easyDistractor: "Ava : Her sabah saat 7'de kalkarım, Bazen yüzümü yıkar ve dişlerimi fırçalarım.",
    correctOptionId: "b",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    unit: "personal_life",
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : I get up at 7 every morning, I always wash my face and I brush my teeth.",
  },
  {
    id: "ava_daily_routine_part2",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about leaving for school.",
    transcript: "Ava : Then I get dressed, and I have breakfast, I leave home for school at half past eight.",
    answerOptions: [
      { id: "a", text: "Ava : Sonra giyinirim ve kahvaltı yaparım, Saat sekiz buçukta okul için evden çıkarım." },
      { id: "b", text: "Ava : Sonra giyinirim ve akşam yemeği yerim, Saat dokuzda okul için evden çıkarım." }
    ],
    easyDistractor: "Ava : Sonra giyinirim ve kahvaltı yaparım, Saat sekiz buçukta okul için evden çıkmam.",
    correctOptionId: "a",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : Then I get dressed, and I have breakfast, I leave home for school at half past eight.",
  },
  {
    id: "ava_daily_routine_part3",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about school time.",
    transcript: "Ava : Lessons start at 9 o'clock, I have lunch at the school canteen.",
    answerOptions: [
      { id: "a", text: "Ava : Dersler saat sekizde başlar, Öğle yemeğini evde yerim." },
      { id: "b", text: "Ava : Dersler saat dokuzda başlar, Öğle yemeğini okul kantininde yerim." }
    ],
    easyDistractor: "Ava : Dersler saat dokuzda başlar, Öğle yemeğini sınıfta yerim.",
    correctOptionId: "b",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : Lessons start at 9 o'clock, I have lunch at the school canteen.",
  },
  {
    id: "ava_daily_routine_part4",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about spending time with Buddy.",
    transcript: "Ava : I come home after school, I usually spend time with Buddy after school.",
    answerOptions: [
      { id: "a", text: "Ava : Okuldan sonra eve gelirim, Okuldan sonra genellikle Buddy ile vakit geçiririm." },
      { id: "b", text: "Ava : Okuldan önce eve gelirim, Okuldan sonra hiç Buddy ile vakit geçirmem." }
    ],
    easyDistractor: "Ava : Okuldan sonra eve gelirim, Okuldan sonra bazen Buddy ile vakit geçiririm.",
    correctOptionId: "a",
    explanation: "",
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : I come home after school, I usually spend time with Buddy after school.",
  },
  {
    id: "ava_daily_routine_part5",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about her evening routine.",
    transcript: "Ava : Then I do my homework, I usually go to bed early.",
    answerOptions: [
      { id: "a", text: "Ava : Sonra ödevimi yaparım, Genellikle erken yatarım." },
      { id: "b", text: "Ava : Sonra televizyon izlerim, Genellikle geç yatarım." }
    ],
    easyDistractor: "Ava : Sonra ödevimi yaparım, Genellikle geç yatarım.",
    correctOptionId: "b",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : Then I do my homework, I usually go to bed early.",
  },
  {
    id: "ava_daily_routine_part6",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about her weekend activities.",
    transcript: "Ava : At weekends, I often visit an animal shelter, I sometimes visit national parks on Saturdays.",
    answerOptions: [
      { id: "a", text: "Ava : Hafta sonları sık sık bir hayvan barınağını ziyaret ederim, Cumartesileri bazen milli parkları ziyaret ederim." },
      { id: "b", text: "Ava : Hafta sonları hiç hayvan barınağını ziyaret etmem, Cumartesileri her zaman evde kalırım." }
    ],
    easyDistractor: "Ava : Hafta sonları sık sık bir hayvan barınağını ziyaret ederim, Cumartesileri her zaman milli parkları ziyaret ederim.",
    correctOptionId: "a",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : At weekends, I often visit an animal shelter, I sometimes visit national parks on Saturdays.",
  },
  {
    id: "ava_daily_routine_part7",
    status: "",
    videoSrc: "assets/video/ava_daily_routine.mp4",
    videoStart: "0:00.000",
    videoEnd: "0:00.000",
    title: "Ava talks about birdwatching on Sundays.",
    transcript: "Ava : At Sundays, I sometimes go watching birds in nature.",
    answerOptions: [
      { id: "a", text: "Ava : Pazar günleri bazen doğada kuş gözlemlemeye giderim." },
      { id: "b", text: "Ava : Pazar günleri her zaman evde televizyon izlerim." }
    ],
    easyDistractor: "Ava : Pazar günleri her zaman doğada kuş gözlemlemeye giderim.",
    correctOptionId: "b",
    explanation: "",
    characterIds: ["ava"],
    grades: [5],
    ...
    evidenceStart: "0:00.000",
    evidenceEnd: "0:00.000",
    evidenceSentence: "Ava : At Sundays, I sometimes go watching birds in nature.",
  }
];
