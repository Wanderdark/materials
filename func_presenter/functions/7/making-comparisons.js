const makingComparisonsFunction = {
  id: "making-comparisons",
  grade: 7,
  unit: 1,
  title: "Making Comparisons",
  description: "",
  exercises: ["making-comparisons-choice", "making-comparisons-sort", "making-comparisons-true-false", "making-comparisons-lucky-spin", "making-comparisons-jumbled"],
  sentences: [
    {
      id: "makingComparisons-intro",
      presenceSlide: true,
      kicker: "COMPARATIVES",
    ...
    {
      id: "makingComparisons-questions",
      presenceSlide: true,
      kicker: "COMPARATIVES",
      title: "more + ADJECTIVE + than",
      imagePath: "images/comperatives/ruletable3.webp",
    ...
    {
      id: "makingComparisons-irregular",
      presenceSlide: true,
      kicker: "COMPARATIVES",
    ...
    {
      id: "makingComparisons-video-ella-sunny",
    ...
    {
      id: "makingComparisons-video-hannah-emma-street-fair",
    ...
    {
      id: "makingComparisons-video-zoe-mia-house",
    ...
    {
      id: "makingComparisons-video-zoe-mia-flat",
    ...
    {
      id: "makingComparisons-video-noah-ethan-tv",
    ...
    {
      id: "makingComparisons-video-chloe-ava-giraffe",
    ...
    {
      id: "makingComparisons-video-lucas-jack-sharks",
    ...
    {
      id: "makingComparisons-video-ella-daniel-roller-coaster",
    ...
    {
      id: "makingComparisons-video-ella-daniel-bumper-cars",
    ...
    {
      id: "makingComparisons-video-hannah-lars-bridge",
    ...
    {
      id: "makingComparisons-video-jack-callum-fish",
    ...
    {
      id: "makingComparisons-video-chloe-julien-trex",
    ...
    {
      id: "makingComparisons-video-daniel-elena-sled",
    ...
    {
      id: "makingComparisons-video-mia-giulia-pizza",
    ...
    {
      id: "makingComparisons-video-chloe-camille-flower",
    ...
    {
      id: "makingComparisons-video-ella-olivia-skyscraper",
    ...
    {
      id: "makingComparisons-video-daniel-lucas-gym",
    ...
    {
      id: "makingComparisons-video-daniel-hannah-storm",
    ...
    {
      id: "makingComparisons-video-jack-david-fishing-rod",
    ...
    {
      id: "makingComparisons-video-ella-sunny-penguins",
    ...
    {
      id: "makingComparisons-student-reveal",
      presenceSlide: true,
      kicker: "COMPARATIVES",
      title: "Compare them!",
...
const makingComparisonsVideoStartIndex = makingComparisonsFunction.sentences.findIndex(
  (item) => item.id === "makingComparisons-video-ella-sunny"
);
...
makingComparisonsFunction.sentences.splice(makingComparisonsVideoStartIndex, makingComparisonsVideoItems.length, {
  id: "makingComparisons-video-hub",
  noVisual: true,
  simplePresentVideoHub: {
    title: "WATCH AND COMPLETE",
    items: makingComparisonsVideoItems
  }
});
