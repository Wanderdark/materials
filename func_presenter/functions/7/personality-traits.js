const personalityWordRevealWords = [
  ...
  { word: "easy-going", definition: "is relaxed, calm and doesn't worry about things.", imagePath: "images/personality/benjamin_easygoing.webp" },
  ...
  { word: "honest", definition: "always tells the truth. He never lies.", imagePath: "images/personality/david_honest.webp" },
  ...
  { word: "outgoing", definition: "is friendly and enjoys meeting new people.", imagePath: "images/personality/ella_sociable.webp" },
  ...
  { word: "generous", definition: "likes giving money and presents to people.", imagePath: "images/personality/emma_generous.webp" },
  { word: "determined", definition: "never gives up easily.", imagePath: "images/personality/ethan_lucas_determined.webp" },
  { word: "punctual", definition: "is always on time.", imagePath: "images/personality/ethan_punctual.webp" },
  { word: "adventurous", definition: "likes trying new and exciting things.", imagePath: "images/goingto-plans/hannah-valley.webp" },
  { word: "selfish", definition: "only thinks about himself. He doesn't like sharing his things. He doesn't care about other people.", imagePath: "images/personality/jack_selfish.webp" },
  { word: "stubborn", definition: "never changes his mind.", imagePath: "images/personality/jack_stubborn.webp" },
  { word: "shy", definition: "feels nervous and uncomfortable with other people.", imagePath: "images/personality/mia_shy.webp" },
  ...
  { word: "serious", definition: "doesn't make jokes and rarely smiles.", imagePath: "images/common/study-noah-1.webp" }
];

const personalityWordRevealSlideCount = Math.ceil(personalityWordRevealWords.length / 6);
const personalityWordRevealSlides = Array.from({ length: personalityWordRevealSlideCount }, (_, index) => ({
  id: `personality-words-${index + 1}`,
  presenceSlide: true,
  personalityWordReveal: {
    kicker: `PERSONALITY WORDS ${index + 1} / ${personalityWordRevealSlideCount}`,
    title: "Click each word to discover its meaning.",
    words: personalityWordRevealWords.slice(index * 6, index * 6 + 6)
  }
}));

const personalityBestFriendVideoCharacters = [
  { name: "AVA", videoUrl: "https://media.adilhoca.com/video/introduce_best_friend_chloe.mp4", videoStopAt: 9, lines: [{ speaker: "AVA", parts: [{ text: "Ava is thoughtful and " }, { answer: "responsible", choices: ["responsible", "forgetful"] }, { text: "." }] }] },
  ...
  { name: "CHLOE", videoUrl: "https://media.adilhoca.com/video/introduce_best_friend_ava.mp4", videoStopAt: 7, lines: [{ speaker: "CHLOE", parts: [{ text: "Chloe is a " }, { answer: "polite", choices: ["polite", "rude"] }, { text: " and " }, { answer: "sensitive", choices: ["sensitive", "stubborn"] }, { text: " person." }] }] },
  ...
  { name: "HANNAH", videoUrl: "https://media.adilhoca.com/video/introduce_best_friend_emma.mp4", videoStopAt: 6.5, lines: [{ speaker: "HANNAH", parts: [{ text: "Hannah is " }, { answer: "adventurous", choices: ["adventurous", "shy"] }, { text: " and cheerful." }] }] },
  ...
  { name: "OLIVIA", videoUrl: "https://media.adilhoca.com/video/introduce_best_friend_ella.mp4", videoStopAt: 10, lines: [{ speaker: "OLIVIA", parts: [{ text: "Olivia is funny and " }, { answer: "creative", choices: ["creative", "clumsy"] }, { text: "." }] }] },
  ...
  { name: "ZOE", videoUrl: "https://media.adilhoca.com/video/introduce_best_friend_mia.mp4", videoStopAt: 10, lines: [{ speaker: "ZOE", parts: [{ text: "Zoe is thoughtful, " }, { answer: "patient", choices: ["patient", "stubborn"] }, { text: ", and a bit " }, { answer: "shy", choices: ["shy", "selfish"] }, { text: "." }] }] }
];
  ...
  sentences: [
    ...personalityWordRevealSlides,
    {
      ...
      definitions: {
        ...
        easyGoing: "is relaxed, calm and doesn't worry about things.",
        ...
        honest: "always tells the truth. He never lies.",
        reliable: "always keeps secrets and promises.",
        cheerful: "is usually happy and smiling.",
        outgoing: "is friendly and enjoys meeting new people.",
        ...
        generous: "likes giving money and presents to people.",
        determined: "never gives up easily.",
        punctual: "is always on time.",
        adventurous: "likes trying new and exciting things.",
        selfish: "only thinks about himself. He doesn't like sharing his things. He doesn't care about other people.",
        stubborn: "never changes his mind.",
        shy: "feels nervous and uncomfortable with other people.",
        serious: "doesn't make jokes and rarely smiles.",
