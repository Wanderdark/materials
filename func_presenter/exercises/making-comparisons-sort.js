const makingComparisonsSortCards = [
...
const makingComparisonsSortExercise = window.exerciseActivityModules.sort({
  id: "making-comparisons-sort",
  title: "SORT IT!",
  ...
  buildBoard() {
    return {
      ...
      cards: makingComparisonsSortCards
    };
  }
});

window.exerciseModules = window.exerciseModules || [];
window.exerciseModules.push(makingComparisonsSortExercise);
