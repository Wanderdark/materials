const makingComparisonsLuckySpinItems = [
  {
...
const makingComparisonsLuckySpinExercise = window.exerciseActivityModules.luckySpin({
  id: "making-comparisons-lucky-spin",
  title: "LUCKY SPIN",
  supports(functionModule) {
    return functionModule.id === "making-comparisons";
  },
  buildItems() {
    return makingComparisonsLuckySpinItems.map((item, index) => ({
      id: `makingComparisons-spin-${index + 1}`,
...
window.exerciseModules.push(makingComparisonsLuckySpinExercise);
